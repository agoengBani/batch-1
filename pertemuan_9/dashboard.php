                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card bg-primary text-white-50">
                                <div class="card-body">
                                    <h5 class="mb-4 text-white"><i class="mdi mdi-account-multiple"></i> Total Mahasiswa</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card bg-success text-white-50">
                                <div class="card-body">
                                    <h5 class="mb-4 text-white"><i class="mdi mdi-account-tie"></i> Total Dosen</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card bg-info text-white-50">
                                <div class="card-body">
                                    <h5 class="mb-4 text-white"><i class="mdi "></i>Total Jurusan</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Daftar Mahasiswa</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
