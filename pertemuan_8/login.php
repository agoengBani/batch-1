...
<body style="
  ...
  <div style="
    ...
    <input type="text" style="padding: 5px; margin-bottom: 10px; box-sizing: border-box" placeholder="Email" />

    <label for="">Password</label>
    <input type="password" style="padding: 5px; margin-bottom: 10px; box-sizing: border-box" placeholder="Password" />
